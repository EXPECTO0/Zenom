...
public:
    ...
    {
        CreateGaugeDialog->setWindowTitle(QCoreApplication::translate("CreateGaugeDialog", "Create Gauge", nullptr));
        ...
        ___qlistwidgetitem->setText(QCoreApplication::translate("CreateGaugeDialog", "Radial", nullptr));
        QListWidgetItem *___qlistwidgetitem1 = gaugeList->item(1);
        ___qlistwidgetitem1->setText(QCoreApplication::translate("CreateGaugeDialog", "Linear", nullptr));
        QListWidgetItem *___qlistwidgetitem2 = gaugeList->item(2);
        ___qlistwidgetitem2->setText(QCoreApplication::translate("CreateGaugeDialog", "Numeric", nullptr));
