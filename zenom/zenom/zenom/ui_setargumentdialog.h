...
public:
    ...
    {
        SetArgumentDialog->setWindowTitle(QApplication::translate("SetArgumentDialog", "Set Argument"));
        groupBox->setTitle(QApplication::translate("SetArgumentDialog", "Parameters"));
        QTableWidgetItem *___qtablewidgetitem = argumentTable->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("SetArgumentDialog", "Type"));
        QTableWidgetItem *___qtablewidgetitem1 = argumentTable->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("SetArgumentDialog", "Name"));
        QTableWidgetItem *___qtablewidgetitem2 = argumentTable->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("SetArgumentDialog", "Log Variable"));
        bindButton->setText(QApplication::translate("SetArgumentDialog", "Bind"));
        unbindButton->setText(QApplication::translate("SetArgumentDialog", "Unbind"));
        groupBox_2->setTitle(QApplication::translate("SetArgumentDialog", "Log Variables"));
    } // retranslateUi
