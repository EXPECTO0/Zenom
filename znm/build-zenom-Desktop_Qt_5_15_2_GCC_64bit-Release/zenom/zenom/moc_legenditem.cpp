...
#include <memory>
#include "../../../zenom/zenom/zenom/plot/legenditem.h"
...
QT_MOC_LITERAL(3, 25, 13), // "removeRequest"
QT_MOC_LITERAL(4, 39, 11) // "sizeChanged"

    },
    "LegendItem\0colorChanged\0\0removeRequest\0"
    "sizeChanged"
};
...
void LegendItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<LegendItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (LegendItem::*)(const QColor & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LegendItem::colorChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (LegendItem::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LegendItem::removeRequest)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (LegendItem::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LegendItem::sizeChanged)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject LegendItem::staticMetaObject = { {
    ...
    qt_meta_stringdata_LegendItem.data,
    qt_meta_data_LegendItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
