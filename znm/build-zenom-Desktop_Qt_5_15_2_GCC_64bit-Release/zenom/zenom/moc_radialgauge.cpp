...
#include <memory>
#include "../../../zenom/zenom/zenom/gauge/radialgauge.h"
...
struct qt_meta_stringdata_RadialGauge_t {
    QByteArrayData data[1];
    char stringdata0[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RadialGauge_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RadialGauge_t qt_meta_stringdata_RadialGauge = {
    {
QT_MOC_LITERAL(0, 0, 11) // "RadialGauge"
...
QT_INIT_METAOBJECT const QMetaObject RadialGauge::staticMetaObject = { {
    QMetaObject::SuperData::link<QwtDial::staticMetaObject>(),
    qt_meta_stringdata_RadialGauge.data,
    qt_meta_data_RadialGauge,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *RadialGauge::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RadialGauge.stringdata0))
