...
#include <memory>
#include "../../../zenom/zenom/zenom/gauge/numericgauge.h"
...
struct qt_meta_stringdata_NumericGauge_t {
    QByteArrayData data[1];
    char stringdata0[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_NumericGauge_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_NumericGauge_t qt_meta_stringdata_NumericGauge = {
    {
QT_MOC_LITERAL(0, 0, 12) // "NumericGauge"
...
QT_INIT_METAOBJECT const QMetaObject NumericGauge::staticMetaObject = { {
    QMetaObject::SuperData::link<QLCDNumber::staticMetaObject>(),
    qt_meta_stringdata_NumericGauge.data,
    qt_meta_data_NumericGauge,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *NumericGauge::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NumericGauge.stringdata0))
