...
public:
    ...
    {
        BindDialog->setWindowTitle(QCoreApplication::translate("BindDialog", "Bind Parameters", nullptr));
        QTreeWidgetItem *___qtreewidgetitem = nodeTree->headerItem();
        ___qtreewidgetitem->setText(0, QCoreApplication::translate("BindDialog", "Node", nullptr));
        closeButton->setText(QCoreApplication::translate("BindDialog", "Close", nullptr));
    } // retranslateUi
