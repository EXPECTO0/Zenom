...
#include <memory>
#include "../../../zenom/zenom/zenom/plot/plot.h"
...
QT_MOC_LITERAL(1, 5, 12), // "autoscaleOff"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 18), // "legendColorChanged"
QT_MOC_LITERAL(4, 38, 6), // "pColor"
QT_MOC_LITERAL(5, 45, 17), // "legendSizeChanged"
QT_MOC_LITERAL(6, 63, 19), // "legendRemoveRequest"
QT_MOC_LITERAL(7, 83, 17) // "zoommed_or_panned"

    },
    "Plot\0autoscaleOff\0\0legendColorChanged\0"
    "pColor\0legendSizeChanged\0legendRemoveRequest\0"
    "zoommed_or_panned"
};
...
void Plot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Plot::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Plot::autoscaleOff)) {
                *result = 0;
                return;
            }
        }
